                   ...
                   name: room_name
                    ...
                    db.Ingame.create({
                        ...
                        if(arr.length >= 9) {
                            ...
                            if(count1 > count2) player_winner = result_room.dataValues.UserId;
                            else player_winner = result_room.dataValues.guest;
        ...
        socket.on('autolost', function(id, room_name) {
            db.Room.findOne({ where: {
               name: room_name
                ...
                var win = id == result_room.UserId ? result_room.guest : result_room.UserId;
                db.Room.update({
                    winner: win
                }, {
                    where: {
