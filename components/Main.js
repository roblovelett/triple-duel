...
// backup
socket = io.connect('https://triple-duel-backup.herokuapp.com/');
// local
...
var Main = React.createClass({
    ...
    handleClickRoom: function(room_name) {
        socket.emit('enterroom', this.state.id, this.state.login, room_name);
        socket.emit('loadrooms');
    },
